...
stock_list = pd.read_pickle("/home/keywin/workspace/crawler/history/stock_list.pkl")
three = pd.read_pickle("/home/keywin/workspace/crawler/three/三大法人買賣超.pkl")
stock_total_release = pd.read_pickle("/home/keywin/workspace/crawler/stock_total_release.pkl")
today = date.today()
...
for stock_id in stock_list.index:
    ...
    if(old_date<=str(today) or three.loc[(stock_id,old_date)].isna().any()):
        ...
        try:
            url = f'https://concords.moneydj.com/z/zc/zcl/zcl.djhtm?a={stock_id}&c={old_date}&d={str(today)}'
...
three.to_pickle("/home/keywin/workspace/crawler/three/三大法人買賣超.pkl")